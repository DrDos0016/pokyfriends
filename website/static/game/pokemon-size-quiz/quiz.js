...
function next_pokemon()
{
    ...
    $('#pokemon_image').attr('src', '/static/global/pokedex-media/pokemon/sugimori/'+(order[position])+'.png');
...
function update_stats(input)
{
    ...
    if (mode == "imperial")
    {
        $('#history').append('<div class="hist-frame" style="background-color: '+bg+'"><span class="pokefont">'+ft_in(answer)+'</span><br><div class="hist-img"><img src="/static/global/pokedex-media/pokemon/sugimori/'+(order[position - 1])+'.png"></div><div class="hist-res"></div><div class="hist-acc pokefont"></div></div>');
        $('.hist-res').last().html(bottom);
    }
    else
    {
        $('#history').append('<div class="hist-frame" style="background-color: '+bg+'"><span class="pokefont">'+in_m(answer)+' m</span><br><div class="hist-img"><img src="/static/global/pokedex-media/pokemon/sugimori/'+(order[position - 1])+'.png"></div><div class="hist-res"></div><div class="hist-acc pokefont"></div></div>');
        $('.hist-res').last().html(bottom);
    }
